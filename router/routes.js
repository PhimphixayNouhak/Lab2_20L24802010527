  ...
  return (
    <NavigationContainer>
        ...
        activeColor={colors.greyLight} inactiveColor={colors.greyDard}>
          ...
          <Tab.Screen name='UserScreens' component={UserScreens} options={{tabBarIcon:getTabBarIcon('person')}}></Tab.Screen>
        </Tab.Navigator>
    </NavigationContainer>
  )
}
...
const DrawerNavigator = ()=>{
  return (
    ...
    <Drawer.Screen name='UserScreens' component={UserScreens} options={{drawerIcon:getDrawerItemIcon('person')}}/>
</Drawer.Navigator>
